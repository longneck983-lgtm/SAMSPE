...
<aside class="sidebar">
    ...
    <nav>
        <ul class="sidebar-nav">
            ...
            <?php endif; ?>
            <?php if (in_array($role, ['teacher', 'admin', 'superadmin'])): ?>
                <li>
            ...
            <?php if ($role === 'admin' || $role === 'superadmin'): ?>
                <li>
                    <a href="manage_codes.php" class="<?= ($activePage == 'manage_codes') ? 'active' : '' ?>">Manage Codes</a>
                </li>
            <?php endif; ?>
            <?php if ($role === 'superadmin'): ?>
                <li>
                    <a href="manage_users.php" class="<?= ($activePage == 'manage_users') ? 'active' : '' ?>">Manage Users</a>
                </li>
            <?php endif; ?>
        </ul>
    </nav>
